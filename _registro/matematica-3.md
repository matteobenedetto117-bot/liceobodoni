...
## Unità 44 — Equazioni esponenziali
- Parole: 413 su 3 pagine di traccia (pagine 89–91 del quaderno: pagina 89 con la definizione, il criterio di esistenza per a^x=b e l'avvio del primo metodo; pagina 90 con gli altri due esempi del metodo per basi uguali; pagina 91 con il metodo dell'incognita ausiliaria e l'unico esempio; la pagina 88 chiude l'unità 43 sul dominio di [f(x)]^g(x), la pagina 92 apre già l'unità 45 sulle disequazioni esponenziali)
- Rettifica: nessuna. Verificato con SymPy tutti e quattro gli esempi: 25^x=125 dà x=3/2 (5^3=125, 5^(2·3/2)=5^3 ✓); 3^x=√3/9 dà x=-3/2 (3^(-3/2)=3^(1/2)/9 ✓); 6·2^(x+3)=4·7^x-2^x dà x=2 (verificato sostituendo: 192=192); 6·3^x-3^(2-x)=15 con z=3^x porta a 2z²-5z-3=0, Δ=49, z=3 o z=-1/2, che dà x=1 (verificato per sostituzione diretta nell'equazione originale: 0=0) e lo scarto di z=-1/2 come impossibile. Tutti i valori della traccia erano già corretti.
- Aggiunta: nessuna oltre alle parole di collegamento fra i passaggi già presenti. Un solo riquadro di attenzione sul motivo per cui z=-1/2 va sempre scartata, perché la traccia lo segnala già scrivendo "IMPOSSIBILE" accanto a quel ramo ma senza spiegarne il motivo. Nessun quesito d'esame: l'argomento richiede ancora i logaritmi (unità 46 in poi) per i casi più generali, e i quesiti di maturità su equazioni esponenziali tipicamente li presuppongono; qui restano solo i casi risolubili per via elementare, come nella traccia.

## Unità 45 — Disequazioni esponenziali
- Parole: 516 su 5 pagine di traccia (pagine 92–96 del quaderno: pagina 92 con la definizione e la regola sul verso secondo la base illustrata con i due grafici, pagina 93 con i due esempi a basi uguali, pagina 94 con i quattro casi particolari, pagine 95–96 con l'esempio a incognita ausiliaria svolto sia con il verso "<7" sia con il verso ">7" complementare; la pagina 91 chiude l'unità 44 sulle equazioni esponenziali, la pagina 97 apre già l'unità 46 sui logaritmi)
- Rettifica: nessuna. Verificato con SymPy: 32^(7/5)=128 (Esempio 1, x>7/5); (1/8)^(2/3)=1/4 (Esempio 2, x<2/3); il prodotto z·(z-18/z-7) espande correttamente a z²-7z-18; le radici dell'equazione ausiliaria sono z=9 e z=-2, come scritto nella traccia. Tutti i valori erano già corretti.
- Aggiunta: nessuna oltre alle parole di collegamento fra i passaggi già presenti. La pagina 96 continua la stessa disequazione ausiliaria con il segno della disequazione di secondo grado invertito rispetto alla pagina 95, senza restituire per esteso il testo del problema complementare: ho reso esplicita la frase "se la disequazione di partenza avesse il verso opposto" per collegare i due svolgimenti, che nella traccia sono semplicemente in sequenza. Il disegno dei due grafici (base maggiore/minore di 1) di pagina 92 è stato ridisegnato in SVG. Nessun quesito d'esame: l'argomento richiede ancora i logaritmi (unità 46 in poi) per i casi più generali, come già osservato per l'unità 44 sulle equazioni esponenziali.

## Unità 46 — Definizione di logaritmo e funzione logaritmica
- Parole: 345 su 2 pagine di traccia (pagine 97–98 del quaderno: pagina 97 con la definizione, gli esempi numerici e i casi particolari; pagina 98 con l'iniettività, la monotonia rispetto alla base e i due grafici della funzione logaritmica; la pagina 96 chiude l'unità 45 sulle disequazioni esponenziali, la pagina 99 apre già l'unità 47 sulle proprietà dei logaritmi)
- Rettifica: nessuna. Verificato con SymPy: log_5(25)=2, log_3(81)=4, log_a(1)=0, log_a(a)=1, a^(log_a b)=b (verificato numericamente con a=7,b=13), 2^(log_2 64)=64 con log_2(64)=6, e i due confronti di monotonia log_10(5)>log_10(2) e log_(1/2)(5)<log_(1/2)(2). Tutti i valori della traccia erano già corretti.
- Aggiunta: nessuna oltre alle parole di collegamento fra i passaggi già presenti. I due grafici affiancati di pagina 98 (esponenziale e logaritmo per a>1 e per 0<a<1) sono stati ridisegnati in SVG, con le due curve simmetriche rispetto alla diagonale y=x per rendere visivamente la relazione di funzione inversa già scritta nella traccia (a^y=x). Nessun quesito d'esame: l'argomento è solo la definizione, e i quesiti che usano i logaritmi in modo sostanziale richiedono le proprietà dell'unità 47.

## Unità 47 — Proprietà dei logaritmi
- Parole: 299 su 2 pagine di traccia (pagine 99–100 del quaderno: pagina 99 con la proprietà del logaritmo di un prodotto, dimostrata, e la sola formula per il logaritmo di un quoziente; pagina 100 con la proprietà del logaritmo di una potenza, dimostrata, e l'esempio 5^x=4 risolto applicando il logaritmo in base 5; la pagina 98 chiude l'unità 46 sulla definizione di logaritmo, la pagina 101 apre già l'unità 48 sul cambiamento di base)
- Rettifica: nessuna. Verificato con SymPy le tre identità (prodotto, quoziente, potenza) simbolicamente per a,b,c,n positivi, e l'esempio 5^x=4: x=log_5(4)≈0,8614, con 5^x=4 confermato numericamente.
- Aggiunta: nessuna oltre alle parole di collegamento fra i passaggi già presenti. Per la proprietà del quoziente, la traccia mostra solo l'enunciato in riquadro senza dimostrazione: è rimasto solo l'enunciato, con una riga che rimanda allo stesso ragionamento della proprietà del prodotto invece di svolgerla per esteso. Nessun quesito d'esame: l'argomento è la sola dimostrazione delle proprietà, propedeutico alle equazioni e disequazioni logaritmiche delle unità 49-50, dove i quesiti di maturità sono alla portata.

## Unità 48 — Formula del cambiamento di base
- Parole: 158 su 1 pagina di traccia (pagina 101 del quaderno: la sola derivazione della formula, senza esempi; la pagina 100 chiude l'unità 47 sulle proprietà dei logaritmi, la pagina 102 apre già l'unità 49 sulle equazioni logaritmiche)
- Rettifica: nessuna. Verificato con SymPy simbolicamente log_a(b) = log_c(b)/log_c(a) per a,b,c positivi, e numericamente log_5(4) = log_10(4)/log_10(5) ≈ 0,8614, coerente con quanto già verificato per l'unità 47.
- Aggiunta: un esempio numerico (log_5 4 ricalcolato in base 10), perché la traccia non ne contiene nessuno per questa unità; ho ripreso lo stesso caso x=log_5 4 già introdotto nell'unità 47, invece di inventarne uno nuovo. Nessun quesito d'esame: l'argomento è solo una formula strumentale, i quesiti che la usano davvero compaiono nelle equazioni e disequazioni logaritmiche delle unità 49-50.

## Unità 49 — Equazioni logaritmiche e condizioni di esistenza
- Parole: 656 su 6 pagine di traccia (pagine 102–107 del quaderno: pagina 102 con la definizione, la forma log_a A(x)=log_a B(x) e le C.E.; pagina 103 con l'Esempio 1 a base fissata, la sua C.E. disegnata su una retta e lo svolgimento fino a x=3; pagina 104 con l'Esempio 2, che porta a un'equazione di secondo grado con discriminante negativo; pagina 105 con l'Esempio 3 a incognita ausiliaria; pagine 106–107 con l'Esempio 4, che richiede il cambiamento di base fra log_{1/2} e log_2; la pagina 101 chiude l'unità 48 sul cambiamento di base, la pagina 108 apre l'unità 50 sulle disequazioni logaritmiche)
- Rettifica: nessuna. Verificato con SymPy tutti e quattro gli esempi: Esempio 1, x(x+3)=2(2x+3) dà x=-2 (scartata, C.E. x>0) e x=3 (accettata); Esempio 2, 3x^2+4x+4=0 ha Δ=16-48=-32, nessuna soluzione reale, coerente con "IMPOSSIBILE" scritto in rosso nella traccia; Esempio 3, t^2-2t-3=0 dà t=3 e t=-1, quindi x=27 e x=1/3, entrambe accettabili; Esempio 4, log_{1/2}(2)=-1 (verificato), x^2-6x=0 dà x=0 (scartata, C.E. x>4) e x=6 (accettata). Tutti i valori della traccia erano già corretti.
- Aggiunta: nessuna oltre alle parole di collegamento fra i passaggi già presenti e la frase sulla convenzione log/ln di pagina 103. Le due rette con le C.E. intersecate (pagine 103 e 106) sono state ridisegnate in SVG al posto dello schizzo a mano libera. Nessun quesito d'esame: l'argomento è la sola tecnica risolutiva delle equazioni logaritmiche, che compare nei quesiti di maturità soprattutto quando combinata con le disequazioni dell'unità 50 o con problemi di modellizzazione più avanti nel percorso.

## Unità 50 — Disequazioni logaritmiche
- Parole: 431 su 2 pagine sostanziali di traccia (pagina 108 del quaderno è bianca; il contenuto reale è su 109–110: l'unico esercizio, a incognita ausiliaria; il titolo "Disequazioni Logaritmiche" compare già in fondo a pagina 107, che chiude l'unità 49 sulle equazioni logaritmiche; la pagina 111 apre l'unità 51 sulle equazioni e disequazioni esponenziali risolte con i logaritmi)
- Rettifica: nessuna. Verificato con SymPy: y²-3y-4 si scompone come (y-4)(y+1); la disequazione (y²-3y-4)/y<0 ha soluzione y<-1 ∨ 0<y<4; il primo ramo log_2(4x)<-1 con dominio x>0 dà 0<x<1/8 (da 4x<2^-1=1/2); il secondo ramo 0<log_2(4x)<4 dà 1/4<x<4 (da 4x>2^0=1 e 4x<2^4=16). Tutti i valori della traccia erano già corretti.
- Aggiunta: nessuna oltre alle parole di collegamento fra i passaggi già presenti. La traccia per questa unità è insolitamente scarna (una pagina bianca e un solo esercizio, senza esempi preliminari a basi uguali né un enunciato esplicito della regola sul verso): ho aggiunto una sola frase che richiama il fatto, già stabilito nelle unità 45-46, che il logaritmo in base maggiore di 1 è crescente e conserva il verso, per collegare l'esempio (che usa sempre base 2) a quel bagaglio, senza enunciare da capo la regola generale né il caso di base compresa fra 0 e 1, che qui non compare. Il quadro dei segni di pagina 109 è stato reso con la tabella già usata altrove nel percorso invece dello schema a mano libera. Nessun quesito d'esame: l'unica tecnica qui sviluppata è quella dell'incognita ausiliaria con un dominio semplice; un quesito di maturità tipico su disequazioni logaritmiche spesso combina più tecniche o basi diverse, non alla portata di questa sola unità.

## Unità 51 — Equazioni e disequazioni esponenziali risolubili con i logaritmi
- Parole: 352 su 2 pagine di traccia (pagine 111–112 del quaderno: pagina 111 con l'equazione 7·5^(2x)=3^(x+1) risolta per logaritmo; pagina 112 con la disequazione 3·2^x>4·3^(x+1); le pagine 109–110 chiudono l'unità 50 sulle disequazioni logaritmiche, la pagina 113 apre l'unità 33 sull'ellisse, aggiunta in coda al quaderno per volontà dell'insegnante come da nota del percorso)
- Rettifica: nella disequazione di pagina 112, il quaderno arriva a x(log2−log3)>log4 e chiude direttamente con x>log4/(log2−log3), senza invertire il verso. Verificato con SymPy che log2−log3 è negativo e che, dividendo per un numero negativo, il verso va invertito: la soluzione corretta è x<log4/(log2−log3) (confermato anche per sostituzione numerica su più valori di x). Nella pagina ho corretto il verso e reso esplicita, in una riga già presente per commentare quel passaggio, la ragione dell'inversione.
- Aggiunta: nessuna oltre alle parole di collegamento fra i passaggi già presenti. Per l'equazione, ho aggiunto una riga sul perché si controlla il segno dei due membri prima di applicare il logaritmo (con il controesempio −7·5^(2x)=3^(x+1) già presente nella traccia), spiegazione necessaria a un passaggio altrimenti implicito. Nessun quesito d'esame: l'argomento è la sola tecnica risolutiva, senza spazio per un quesito autonomo alla portata di queste due sole pagine. Con questa unità il percorso di matematica terza è completo (51 unità su 51).
