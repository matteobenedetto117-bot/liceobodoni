...
- Revisione, figure: lo schema di Sarrus, che nella traccia è un disegno con le diagonali cerchiate in verde e in rosso, era reso con una tabella LaTeX e una riga di testo. Ora è una figura SVG interattiva, ripetuta tre volte come nella traccia: con le lettere, sull'esempio numerico e sul determinante D del sistema dell'esempio di Cramer, così la regola si vede applicata proprio dove serve.
- Revisione, figure interattive: in ciascuno dei tre schemi un cursore percorre le sei diagonali una per volta (le tre discendenti in verde, poi le tre ascendenti in rosso), evidenziandole sulla matrice con le due colonne copiate a destra; sotto compaiono il prodotto della diagonale corrente, la somma parziale A, poi la somma parziale B e infine D = A − B.
- Revisione, ordine (richiesta dell'utente): la regola di Sarrus non apre più l'unità ma sta dentro la sezione su Cramer, dopo sostituzione e riduzione, dove serve davvero. I titoletti principali sono quindi «Metodo di sostituzione», «Metodo di riduzione» e «Regola di Cramer per i sistemi 3×3»; dentro quest'ultimo, «La regola di Sarrus», «Un esempio numerico» e «Esempio: lo stesso sistema con Cramer».
