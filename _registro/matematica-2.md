...
- Revisione: titolo e titoletti invariati (scelta dell'utente: Circonferenza, Cerchio, Circonferenza per tre punti). Tolti il sottotitolo e la sezione "Nella prossima unità". Definizioni e teorema nei riquadri .def. Aggiunta la motivazione dell'ipotesi "non allineati" (una retta e una circonferenza hanno al più due punti in comune). Corretto il disegno: nella versione precedente l'estremo del raggio non stava sulla circonferenza e la didascalia citava un punto A non disegnato. Impaginazione a quaderno. Figure interattive: raggio OP con cursore sulla posizione di P (OP resta r); circonferenza e cerchio affiancati con cursore sulla distanza OQ, che dice se Q appartiene alla circonferenza (solo OQ = r) e al cerchio (OQ ≤ r). La seconda figura è stata tenuta su richiesta dell'utente.

## Unità 59 — Archi, angoli al centro, settori e segmenti circolari
