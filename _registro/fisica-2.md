...
- Revisione (22/09/2026): titolo «Tipi di proporzionalità» e titoletti «Proporzionalità diretta», «inversa», «quadratica» confermati dall'utente; tolto il sottotitolo. Precisazioni: il rapporto costante è $y/x$, il prodotto costante è $xy$; la proporzionalità quadratica è detta «y direttamente proporzionale al quadrato di x»; le descrizioni dei grafici (ramo di iperbole, ramo di parabola) valgono per x e k positivi; l'iperbole «si avvicina agli assi senza toccarli». Impaginazione a quaderno per la LIM, formule nei riquadri azzurri. Figure: i tre grafici disegnati a mano (curve non calcolate, raddoppio non in scala) sono stati sostituiti, su richiesta dell'utente, da un grafico per ciascun capitoletto, calcolato (y = x, y = 1,5/x, y = 0,25x²) e interattivo: punto fisso x₁ = 1,5 in rosso, cursore su x₂ con punto verde sulla curva; sotto si leggono i fattori x₂/x₁ e y₂/y₁ e la grandezza costante (y/x, xy, y/x²), e con x₂ = 2x₁ compare in verde «y raddoppia / si dimezza / quadruplica».
